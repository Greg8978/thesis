...
%HATP
Pour calculer des plans de collaboration, nous utilisons HATP, un planificateur HTN modifié, spécialement conçu pour la robotique \cite{lallement14}.
...
\end{enumerate}
Ces règles permettent réduire la taille de l'arbre à traiter et de le rendre plus adapté à la verbalisation et à la surveillance de l'activité de l'homme.
